...
const HeroSec = () => {
    return (
        <section
            className="min-h-[90dvh] pt-32.5 pb-20 px-12 flex flex-col justify-end relative overflow-hidden md:pt-30 md:px-6">
            ...
            <div className="hero-index absolute top-35 right-12 hidden md:block
              ...
              [writing-mode:vertical-rl] rotate-180
               animate-fade-in [animation-delay:1.2s]">
                Full Stack Dev <span className="text-red">/ 2026</span>
            </div>
            ...
            <h1 className="hero-h1 font-serif font-light leading-none tracking-tighter text-ink relative">
                <span className="block overflow-hidden"><span
                    className="word w1 inline-block  animate-word-up [animation-delay:0.15s] mb-5">Making</span></span>
                <span className="block overflow-hidden"><span
            ...
            <div className="flex items-end justify-between mt-15
              ...
              flex-col gap-7 md:flex-row md:items-end">
                <p className="max-w-85 text-[15px] leading-[1.7] text-mid font-normal">
                    Full-stack JavaScript developer specializing in <strong className="text-ink font-medium">Node.js, Next.js, React, Tailwind CSS, and NoSQL databases like MongoDB</strong>. Skilled in building modern, scalable, and responsive web applications with <strong className="text-ink font-medium">clean UI, efficient backend architecture</strong>, and seamless user experiences.
                </p>
                <div className="flex flex-col items-end gap-3 md:items-end">
                    <Link href='/projects' className="inline-flex items-center gap-2.5 text-[13px] font-bold tracking-wide uppercase
